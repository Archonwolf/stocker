export default function Hero() {
    return(
        <div class="container mt-5">
            <div class="row mb-5">
                <h1 class="fs-2 text-center mt-5 mb-5">We pioneered the discount broking model in India.
               <br></br> Now, we are breaking ground with our technology.</h1>
            </div>
            <div class="row mt-5 mb-5 border-top">
                <div class="col-6 mt-5" style={{width: "40%", marginLeft: "6%"}}>
                ...
                cost, support, and technology. We named the company Zerodha, a combination of
                 Zero and "Rodha", the Sanskrit word for barrier.</p>
                ...
                <div class="col-6 mt-5" style={{width: "40%", marginLeft: "5%"}}>
